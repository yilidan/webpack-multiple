  ...
  return (
    <div className="svg-container" style={svgContainerStyle}>
      <div className="btn-container">
        <button onClick={() => animate(1)}>点我到达第二个点</button>
        <button onClick={() => animate(2)}>点我到达第三个点</button>
        <button onClick={() => animate(3)}>点我到达第四个点</button>
      </div>
      <div className="row1">
        <span>1</span>
        <span>2</span>
...
ReactDOM.render(<SVGAnimation />, document.getElementById("app"))
